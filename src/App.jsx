...
import "./App.css";
import imageName from "/assets/Oval.png";
import img from "/assets/Rectangle.png";
import img1 from "/assets/Rectangle-Copy.png";
import img2 from "/assets/Rectangle-Copy 2.png";
import img3 from "/assets/Rectangle-Copy 3.png";
import img4 from "/assets/Rectangle-Copy 4.png";
...
function App() {
  ...
  const addToCart = () => {
    setCartItems(cartItems + 1); // Increment cart item count
    setCartPopupVisible(true);  // Show cart popup
    setTimeout(() => setCartPopupVisible(false), 3000); // Hide after 3 seconds
  };
  ...
  return (
    <div className="container">
      ...
      <div className="header">
        <h1 className="main-title">Sneakers</h1>
      ...
      <div className="main-content">
        <div className="main-image" onClick={() => openModal(img1)}>
            ...
            <button className="add-to-cart" onClick={addToCart}>
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M14.5 1.5H3.5C2.67 1.5 2 2.17 2 3V12C2 12.83 2.67 13.5 3.5 13.5H14.5C15.33 13.5 16 12.83 16 12V3C16 2.17 15.33 1.5 14.5 1.5ZM9 10V7H7V10H4L8 14L12 10H9Z"
                  fill="white"
                />
              </svg>
              Add to Cart
